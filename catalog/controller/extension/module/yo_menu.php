...
class ControllerExtensionModuleYoMenu extends Controller {
	public function index($setting) {
		...
		if ($data['style_status'] && $data['style']) {
			$style = fopen('catalog/view/theme/vershina/stylesheet/yo/menu/yo-'.$module.'.css', 'w+');
			fwrite ($style, $data['style']);
			fclose ($style);
			$this->document->addStyle('catalog/view/theme/vershina/stylesheet/yo/menu/yo-'.$module.'.css');
		}
		...
		if (file_exists('catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/yo/menu/yo-' . $data['menu_design'] . '.css')) {
			...
			$this->document->addStyle('catalog/view/theme/vershina/stylesheet/yo/menu/yo-' . $data['menu_design'] . '.css');
		}
