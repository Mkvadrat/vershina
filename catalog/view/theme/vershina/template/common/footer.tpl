            ...
            <div id="call-to-me">
                ...
                <div>
                    ...
                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <label class="choose"><span class="check-arrow" style="display: none;"></span><input type="checkbox"> я согласен (согласна) с <a href="/index.php?route=information/information&information_id=3">политикой конфиденциальности</a></label>
...
<script type='text/javascript'>
(function(){ var widget_id = 'CQdrf57yGf';var d=document;var w=window;function l(){var s = document.createElement('script'); s.type = 'text/javascript'; s.async = true;s.src = '//code.jivosite.com/script/widget/'+widget_id; var ss = document.getElementsByTagName('script')[0]; ss.parentNode.insertBefore(s, ss);}if(d.readyState=='complete'){l();}else{if(w.attachEvent){w.attachEvent('onload',l);}else{w.addEventListener('load',l,false);}}})();
</script>
