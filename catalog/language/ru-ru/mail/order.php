...
$_['text_new_greeting']         = 'Благодарим Вас за интерес к товарам нашего интернет-магазина строительного оборудования ООО Вершина www.vershina92.ru';
...
$_['text_new_footer']           = 'Если у Вас есть вопросы по заказу, пожалуйста, ответьте на это письмо.';
